...
var viewx = view_x/dev - view_wview/2; 
var viewy = view_y/dev - view_hview/2;
...
else if view_xview > room_width - view_wview {view_xview = room_width - view_wview}
if view_yview < 0 {view_yview = 0;}
else if view_yview > room_height - view_hview {view_yview = room_height - view_hview}
}
